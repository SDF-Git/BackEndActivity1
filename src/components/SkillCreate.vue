<template>
    ...
    <div v-if="!isUpdate"><h2 class="text-center">Add New Skill</h2></div>
    <div v-else><h2 class="text-center">Edit Skill</h2></div>
        ...
        <div class=" col align-items-center">
          <div class="row align-items-center justify-content-center">
            <div class="col col-12 col-sm-10 col-md-10 col-lg-6">
                ...
                <div v-if="showMsg" :class="['alert', showMsg === 'error' ? 'alert-danger' : 'alert-success']">
                    <span v-if="showMsg === 'error'">Please verify skill information.</span>
                    <span v-else-if="showMsg === 'requestError'">Data formatting issue.</span>
                </div>
                </div>
          </div>
          <div class="row align-items-center justify-content-center">
                  ...
                  <form ref="form">
                    <div class="container-fluid">
                      ...
                      <div class="row justify-content-around">
                        ...
                        <div v-else type="button" class="btn btn-primary col-4" @click="updateSkill">Update</div>
